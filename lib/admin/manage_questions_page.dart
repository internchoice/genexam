            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  final options =
                  optionCtrls.map((e) => e.text.trim()).toList();
                  ...
                  if (question.isEmpty ||
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                          content: Text(
                              "Please fill all fields and mark correct answer")),
                    );
                    return;
                  }
                          ...
                          children: [
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 6),
                                  Text(
                                    "Section: ${q['section']} | Marks: $marks | Options: ${options.length}",
                                    style: const TextStyle(
                                      fontSize: 14,
                                      color: Colors.grey,
                                    ),
                            ...
                            Row(
                              ...
                              children: [
                                IconButton(
                                  onPressed: () =>
                                      _editQuestion(context, q),
                                  icon: const Icon(Icons.edit,
                                      color: Colors.blue),
                                ),
                                IconButton(
                                  onPressed: () =>
                                      _deleteQuestion(context, q.id),
